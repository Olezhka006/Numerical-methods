...
print(f"\nЛагранж 1 степени Y = {l1(points_x1_1, x1):.4f}")
print("Таблица (1 степень):")
print("x:  0.2   0.4")
print("y:  1.099 1.078")

print(f"\nЛагранж 2 степени Y = {l2(points_x1_2, x1):.4f}")
print("Таблица (2 степень):")
print("x:  0.0   0.2   0.4")
print("y:  1.000 1.099 1.078")

print(f"\nЛагранж 1 степени Y = {l1(points_x2_1, x2):.4f}")
print("Таблица (1 степень):")
print("x:  0.8   1.0")
print("y:  1.294 1.443")

print(f"\nЛагранж 2 степени Y = {l2(points_x2_2, x2):.4f}")
print("Таблица (2 степень):")
print("x:  0.8   1.0   1.2")
print("y:  1.294 1.443 1.614")

print(f"\nЛагранж 1 степени Y = {l1(points_x3_1, x3):.4f}")
print("Таблица (1 степень):")
print("x:  1.6   1.8")
print("y:  2.016 2.243")

print(f"\nЛагранж 2 степени Y = {l2(points_x3_2, x3):.4f}")
print("Таблица (2 степень):")
print("x:  1.4   1.6   1.8")
...
x_x1 = [x[1], x[2]]  
y_x1 = [y[1], y[2]]  
print(f"\nНьютон 1 степени Y = {n1(x_x1, y_x1, x1, 1):.4f}")
print("Таблица (1 степень):")
print("x    y      Δy")
...
x_x1_2 = [x[0], x[1], x[2]]  
y_x1_2 = [y[0], y[1], y[2]]  
print(f"\nНьютон 2 степени Y = {n1(x_x1_2, y_x1_2, x1, 2):.4f}")
print("Таблица (2 степень):")
print("x    y      Δy     Δ²y")
...
x_x2 = [x[4], x[5]]  
y_x2 = [y[4], y[5]]  
print(f"\nНьютон 1 степени Y = {n1(x_x2, y_x2, x2, 1):.4f}")
print("Таблица (1 степень):")
print("x    y      Δy")
...
x_x2_2 = [x[4], x[5], x[6]]  
y_x2_2 = [y[4], y[5], y[6]]  
print(f"\nНьютон 2 степени Y = {n1(x_x2_2, y_x2_2, x2, 2):.4f}")
print("Таблица (2 степень):")
print("x    y      Δy     Δ²y")
...
x_x3 = [x[8], x[9]]  
y_x3 = [y[8], y[9]]  
print(f"\nНьютон 1 степени Y = {n2(x_x3, y_x3, x3, 1):.4f}")
print("Таблица (1 степень):")
print("x    y      Δy")
...
x_x3_2 = [x[7], x[8], x[9]]  
y_x3_2 = [y[7], y[8], y[9]]  
print(f"\nНьютон 2 степени Y = {n2(x_x3_2, y_x3_2, x3, 2):.4f}")
print("Таблица (2 степень):")
print("x    y      Δy     Δ²y")
